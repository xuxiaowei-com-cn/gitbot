...
import cn.com.xuxiaowei.gitbot.exception.GitbotRuntimeException;
...
public class RedisUtils {
	...
	public static String redisVersion(RedisAccessor redisAccessor) {
		...
		if (connectionFactory == null) {
			throw new GitbotRuntimeException("Redis 连接工厂 为 null");
		}
		...
		if (info == null) {
			throw new GitbotRuntimeException("Redis 连接属性 为 null");
		}
